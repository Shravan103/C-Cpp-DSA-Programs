...
int customer ::display(customer list[100], int n)
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        cout<<"The account holders phone number is "<<list[i].phone<<endl;
...
int customer ::search(customer list[100], int n, int number)
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        {
            cout<<"The name of the account holder is "<<list[i].name<<endl;
            cout<<"The phone number of account holder is "<<list[i].phone<<endl;
...
int main()
{
    ...
    customer * ptr;
    customer data[100];
    cout<<"Enter the MAX size for storage"<<endl;
    cin>>g;
    ptr =(customer *)calloc(g,sizeof(customer));
